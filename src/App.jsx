...
function App() {  
    ...
    return (
        <div className='bg-[#D8BFD8] min-h-screen max-h-full'>
            <div className='flex justify-between items-center bg-[#8037b4] '>
                ...
                <div className='mx-8 my-2'>
                    <button
                        ...
                        id='connect_button'
                        className='bg-[#D8BFD8] m-4 p-4 px-20 rounded-md'
                    >
                        connect wallet
                    </button>
                </div>
                            ...
                            <div className='flex flex-col md:w-1/2 rounded-lg border-white border-4 justify-self-center items-center'>
                                {cid ? (
                                    ...
                                    <div className='flex flex-col md:flex-row justify-around items-center m-4'>
                                        ...
                                        <button
                                            onClick={uploadImg}
                                            className='bg-[#8037b4] rounded-md'
                                        >
                                            <div className='m-2'>
                                                Upload to IPFS
                                            </div>
                                ...
                                {signature ? (
                                    ...
                                    <div className='w-full p-4'>
                                        <button
                                            ...
                                            className='bg-[#8037b4] w-full p-4 rounded-md'
                                        >
                                            Sign the CID
                                        </button>
                                    </div>
                                ...
                                <div>
                                    {signature && (
                                        <button
                                            className='bg-[#8037b4] w-full p-4 rounded-md m-4'
                                            onClick={saveData}
                                        >
                                            save to blockchain
                                        </button>
                                ...
                                <div className='flex flex-col justify-center items-center'>
                                    {!showSignerInput ? (
                                        <button
                                            ...
                                            className='bg-[#8037b4] m-4 mb-1 p-4 px-20 rounded-md indie font-semibold text-2xl'
                                        >
